...
class LeaderViewController: KWSBaseController {
    ...
    override func viewDidLoad() {
        ...
        RxKWS.getLeaderboard()
            ...
            .toArray()
            .bindTable2(tableView)
            .customiseRow2(cellIdentifier: LeaderHeader.Identifier,
            ...
            .customiseRow2(cellIdentifier: LeaderRow.Identifier,
            ...
            .subscribe(onNext: { (data: [ViewModel]) in
                
                print("In subscribe \(data)")
